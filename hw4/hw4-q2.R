...
heart <- read.table("heart-2.txt", header=T)
herat.dag <- dag(~systol:smoke:mental:phys:protein:family + smoke:physical:mental + protein:family)
...
querygrain(heart.net, nodes=c("systol", "mental"), type="joint") #mental stress to develop high BP -- 33.76%
